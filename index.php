...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">    <title>Ingreso</title>
</head>
<body>
    <form action="" method="POST">
        <?php require_once "app/views/helpers/login.php"; ?>
        <div class="logo">
            <img src="app/views/img/logo.png" alt="logo">
        </div>
